...
namespace AoC_day_5
{
    ...
    {
        static List<int[]> getLine(int[] coord1, int[] coord2)
        {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (string row in data)
            {
                ...
                string[] coord1string = coords[0].Split(',');
                string[] coord2string = coords[2].Split(',');
                int[] coord1 = Array.ConvertAll(coord1string, i => int.Parse(i));
                int[] coord2 = Array.ConvertAll(coord1string, i => int.Parse(i));
